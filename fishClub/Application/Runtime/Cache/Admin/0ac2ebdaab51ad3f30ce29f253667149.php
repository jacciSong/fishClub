					...
					<form class="layui-form" action="" id="staffForm">
						<div class="layui-form-item itemheight">
							...
							<div class="layui-input-block">
								<input type="text" id="name" name="name" lay-verify="required" autocomplete="off" placeholder="Please enter the name" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item itemheight">
							<label class="layui-form-label">Detail</label>
							<div class="layui-input-block">
								<textarea type="text" id="detail" name="detail" lay-verify="required" placeholder="Please enter the details" autocomplete="off" class="layui-textarea"></textarea>
							</div>
						</div>
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline" style="width: 200px;">
								<input type="text" name="count" autocomplete="off" class="layui-input" placeholder="Please enter the max count">
							</div>
						</div>
			...
			layui.use(['form', 'layedit', 'laydate'], function() {
				...
				form.on('submit(register)', function(data) {
					...
					$.ajax({
						...
						type: "POST",
						dataType: "JSON",
						url: '/fishClub/index.php/Admin/WareManage/addWareInfo',
