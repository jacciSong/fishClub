				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<table class="layui-table" lay-data="{url:'/fishClub/index.php/Admin/ContactInformation/contactDatatable',  page:false, id:'idTest', limit:5}" lay-filter="demo">
								<thead>
									<tr>
										<th lay-data="{field:'email', align:'center'}">Email</th>
										<th lay-data="{field:'phone', align:'center'}">Phone</th>
				...
				table.on('tool(demo)', function(obj) {
					...
					if(obj.event === 'edit') {
						...
						layer.open({
							...
							area: ['50%', '40%'],
							content: '/fishClub/index.php/Admin/ContactInformation/editContact?id=' + id,
							end: function() {
								var table = layui.table;
								table.reload('idTest');
							}
