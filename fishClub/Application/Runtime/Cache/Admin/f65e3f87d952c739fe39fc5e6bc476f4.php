					...
					<form class="layui-form" action="" id="staffForm">
						<div class="layui-form-item itemheight">
							...
							<div class="layui-input-block">
								<input type="text" id="code" name="code" lay-verify="required" autocomplete="off" class="layui-input" value="<?php echo ($code); ?>" readonly="readonly">
							</div>
						</div>
						<div class="layui-form-item itemheight">
			...
			layui.use(['form', 'layedit', 'laydate'], function() {
				...
				form.on('submit(register)', function(data) {
					...
					$.ajax({
						...
						type: "POST",
						dataType: "JSON",
						url: '/fishClub/index.php/Admin/DiscountManage/addDiscountInfo',
