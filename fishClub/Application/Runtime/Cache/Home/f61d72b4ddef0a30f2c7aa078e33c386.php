	...
	<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
		<div id="wrapper pageCon">
			<div id="registerCon">
				...
				<input placeholder="First Name" class="logInput" id="fN"/>
				<input placeholder="Last Name" class="mgT-20 logInput" id="lN"/>
				<input placeholder="Email" class="mgT-20 logInput" id="email"/>
				<input placeholder="Password" class="mgT-20 logInput" id="password" type="password"/>
				<button class="mgT-20 layui-btn btncol">Create</button>
				<a class="mgT-20 blueFont"> or Return to Store</a>
			</div>
		</div>
		<!-- 全局js -->
